...
const RecordInfo = () => {
   ...
   /*
   *    todo
   *    массив spans плохая идея.
   *    В результате имена полей проиндексированы, семантика потеряна, код стал читаться хуже
   *    связь между label и именем поля разорвана.
   *
   *    Код компонента должен рендерить структуру данных - на основании полученных данных и конфигурации labels.
   *    Labels должен содержать в себе все необходимые связи.
   *    Он должен соеджать соответсвие метка для данных - где эти данные взять.
   * */
